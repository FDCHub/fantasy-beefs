...
**Revision:** Rev 6 (af-1 BUILT — control-surface green)
...
Ruled corrections: **All applied** — §6/§7 af-1 completion definition; §5.5 canonical option policy; Rev 3 editorial tightening; Rev 4 structural contract + environment prerequisite; Rev 5 §5.4 AST alignment; Rev 6 post-build path + variance record
Control tests: **`test_af1_engine_control_surface_red.py` Rev 6** — 13/13 green
Open calls: **None**

**af-1: BUILT — CONTROL-SURFACE GREEN** (2026-07-22).
