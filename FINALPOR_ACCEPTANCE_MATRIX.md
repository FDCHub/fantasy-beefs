...
**Every backend package — WP-4, WP-5, WP-6, WP-8, WP-9, WP-11, WP-12, WP-13, WP-14, WP-15, WP-16 and WP-18 — is complete and are no longer listed here.** **Every backend work package is complete, and UI-2 and UI-3A–D are complete.** The next packages are **UI-5** (Wrap Up), **UI-7** (Rules / League Settings), and finally **WP-17** (demo).
