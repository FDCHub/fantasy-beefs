...
**Status:** PARTIAL — 12 of 25 work packages complete. Not pushed, not deployed, not tagged.
...
**WP-4, WP-5, WP-6, WP-9, WP-12 and WP-13 are complete and are no longer listed here.** The next package is **WP-8** (FantasyStakes lifecycle retiming: postseason scoring stays LIVE; retire `championship_scoring_gate` and `REASON_POSTSEASON_CONTAMINATED`).
