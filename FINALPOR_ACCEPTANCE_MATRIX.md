...
**Status:** PARTIAL — 15 of 25 work packages complete. Not pushed, not deployed, not tagged.
...
**WP-4, WP-5, WP-6, WP-8, WP-9, WP-11, WP-12, WP-13 and WP-14 are complete and are no longer listed here.** The next package is **WP-15** (My Settle / Current Settle reshape + the optional external mapping rule).
