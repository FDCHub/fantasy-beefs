...
**Status:** PARTIAL — 18 of 25 work packages complete. Not pushed, not deployed, not tagged.
...
**Every backend package — WP-4, WP-5, WP-6, WP-8, WP-9, WP-11, WP-12, WP-13, WP-14, WP-15, WP-16 and WP-18 — is complete and are no longer listed here.** **Every backend work package is now complete.** The next packages are the UI: **UI-2** (six-column Standings), **UI-3A–D** (Play), **UI-5** (Wrap Up), **UI-7** (Rules / League Settings), and finally **WP-17** (demo).
