...
**Status:** PARTIAL — 16 of 25 work packages complete. Not pushed, not deployed, not tagged.
...
**WP-4, WP-5, WP-6, WP-8, WP-9, WP-11, WP-12, WP-13, WP-14 and WP-15 are complete and are no longer listed here.** The next package is **WP-16/WP-18** (complete the governed retirements now their replacements are live, and supersede the governing specs), then the remaining UI packages.
