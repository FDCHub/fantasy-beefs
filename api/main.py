...
# No payment-processing module is imported. Payment processing is out of the
...
def payments_set_buyin_enforcement(
    ...
    payment meaning. Renaming both is deferred to a controlled
    post-MVP migration.
    """
    try:
...
#
# Payment processing is out of the MVP, so the rail these routes were built on no
