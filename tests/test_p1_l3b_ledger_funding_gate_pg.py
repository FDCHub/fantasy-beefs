...
print("\nL3B-11: no processor / payout-method / real-money surface introduced")

_MONEY_TOKENS = {
    "payment_intent", "PaymentIntent", "connected_account",
...
_assert("L3B-11 negative control: scanner ignores comment/docstring prose",
        "payment_intent" not in _probe_toks and "plaid" not in _probe_toks)
