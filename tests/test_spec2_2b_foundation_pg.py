...
batch / provenance foundation (PostgreSQL).
    ...
    F18 no payment-processor or real-money concept was introduced
...
def main(tdb) -> None:
    ...
    # ══════════════════════════════════════════════════════════════════════
    # F18 — no payment-processor / real-money concept
    # ══════════════════════════════════════════════════════════════════════
    print("\nF18  no payment-processor or real-money concept was introduced")
    for rel in ("ledger/ledger.py",
        ...
        _assert(f"F18 {rel} contains no payment-processor symbol in executable code",
    ...
    _assert("F18 the Group 1 schema section introduces no payment concept",
            "payment_intent" not in new_section.lower(),
            "the section is payment-processor-free")
