...
def main(tdb) -> None:
    ...
    # never calls post(session=None) and contains no payment path. A naive grep
    ...
    _assert("A11 no payment-processor symbol appears on this path",
            re.search(r"payment_intent|connected_account|payout_method", svc_src, re.I) is None)
