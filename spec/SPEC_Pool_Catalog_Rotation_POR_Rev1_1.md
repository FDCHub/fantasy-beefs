...
# Product of Record, Revision 1.1

**Status:** Product of Record — current
**Date:** 2026-08-01
**Source artifact:** `FR-6_1_CATALOG_CLASSIFICATION.md` (96-row classified catalog)
**Machine-readable catalog:** `spec/pool_catalog_rev1_1.json`
**Implementation scope:** `spec/SPEC_Pool_Rotation_Implementation_Scope_Rev1_1.md`

**Revision 1.1 supersedes Revision 1.0 as the current Product of Record. Revision 1.0 is retained unchanged as historical authority.**
...
94 active definitions. Machine-readable form with complete metadata is `spec/pool_catalog_rev1_1.json`.
