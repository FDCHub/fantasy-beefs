...
Funding model
  • No payment processing. Payment processing is out of the MVP: there is no
...
def apply_pending_topups(db: Session) -> list[FaabTxRecord]:
    ...
    Payment processing is out of the MVP and the B6 issuance-ledger model does not exist
